...
/**
 * Basis-Darstellungsfenster, das ein beliebiges Panel als Content übernehmen
 * kann.
 * @author Lisa Vittori
 * @version 2019-11-25
 */
public class GenericFrame extends JFrame {
   ...
   */
  public GenericFrame(String titel, Container content, boolean resizable) {
    super(titel);
   ...
   * @param content Der im Fenster angezeigte Inhalt
   */
  public GenericFrame(String titel, Container content) {
   ...
   */
  public GenericFrame(String titel, Container content, boolean resizable, int width, int height) {
   ...
   * @param height Die Höhe des Fensters
   */
  public GenericFrame(String titel, Container content, int width, int height) {
